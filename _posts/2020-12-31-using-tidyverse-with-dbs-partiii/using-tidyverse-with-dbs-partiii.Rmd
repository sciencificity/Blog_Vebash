...
<aside>DBI is the <b>D</b>ata<b>B</b>ase <b>I</b>nterface `r emo::ji("package")` for R. Instead of using an ODBC driver we may use one of the DBI compliant packages created by the R community to make a connection. In the case of MySQL we use `RMariaDB` `r emo::ji("package")`</aside>
