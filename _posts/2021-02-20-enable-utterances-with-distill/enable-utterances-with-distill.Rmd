...
1. You then need to allow the app access to your __blog repository (repo)__ in GitHub. My blog repo is named `Blog_Vebash` (inspired, eh `r emoji::emoji("zipper_mouth_face")`).
...
## Someone commented `r emoji::emoji("tada")`
